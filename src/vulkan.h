...
typedef VkResult (VKAPI_PTR *PFN_vkQueueSubmit)(VkQueue graphicsQueue, uint32_t submitCount, const VkSubmitInfo* pSubmits, VkFence fence);
typedef VkResult (VKAPI_PTR *PFN_vkQueueWaitIdle)(VkQueue graphicsQueue);
...
typedef VkResult (VKAPI_PTR *PFN_vkQueueBindSparse)(VkQueue graphicsQueue, uint32_t bindInfoCount, const VkBindSparseInfo* pBindInfo, VkFence fence);
...
typedef VkResult (VKAPI_PTR *PFN_vkQueuePresentKHR)(VkQueue graphicsQueue, const VkPresentInfoKHR* pPresentInfo);
